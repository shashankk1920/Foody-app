      ...
      <div className="relative z-10 max-w-4xl w-full px-6 py-10">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <h2 className="text-xl font-semibold mt-6 mb-2 flex items-center">
            <FaUserShield className="mr-2 text-purple-500" /> Use of Service
          </h2>
          ...
          <h2 className="text-xl font-semibold mt-6 mb-2 flex items-center">
            <FaDatabase className="mr-2 text-blue-500" /> Account Responsibility
          </h2>
          <p className="mb-4 text-gray-700">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-2 flex items-center">
            <FaLock className="mr-2 text-red-500" /> Orders & Payments
          </h2>
          ...
          <h2 className="text-xl font-semibold mt-6 mb-2 flex items-center">
            <FaSyncAlt className="mr-2 text-yellow-500" /> Content Ownership
          </h2>
          <p className="mb-4 text-gray-700">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-2 flex items-center">
            <FaEnvelopeOpenText className="mr-2 text-green-500" /> Prohibited Activities
          </h2>
          <ul className="list-disc list-inside space-y-2 pl-4 text-gray-700">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-2 flex items-center">
            <FaSyncAlt className="mr-2 text-orange-500" /> Termination
          </h2>
          <p className="mb-4 text-gray-700">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-2 flex items-center">
            <FaUserShield className="mr-2 text-purple-500" /> Limitation of Liability
          </h2>
          <p className="mb-4 text-gray-700">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-2 flex items-center">
            <FaSyncAlt className="mr-2 text-yellow-500" /> Changes to Terms
          </h2>
          <p className="mb-4 text-gray-700">
